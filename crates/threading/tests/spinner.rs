...
mod tests {
    ...
    fn test_spinner_new() {
        ...
        assert!(
            spinner.message().contains("Initializing"),
    ...
    fn test_spinner_suspend() {
        ...
        let result = spinner.suspend(|| "suspended");
    ...
    fn test_spinner_finish_with_message() {
        ...
        assert!(
            spinner.is_finished(),
            "Should be finished after finish_with_message()"
        );
        ...
        assert!(
            result.is_err(),
            "finish_with_message should fail if already finished"
        );
    }
    ...
    fn test_spinner_finish_using_style() {
        ...
        assert!(
            spinner.is_finished(),
            "Should be finished after finish_using_style()"
        );
        ...
        assert!(
            result.is_err(),
            "finish_using_style should fail if already finished"
        );
    }
    ...
    fn test_spinner_finish_and_clear() {
        ...
        assert!(
            spinner.is_finished(),
            "Should be finished after finish_and_clear()"
        );
        ...
        assert!(
            result.is_err(),
            "finish_and_clear should fail if already finished"
        );
    }
    ...
    fn test_spinner_abandon_with_message() {
        ...
        assert!(
            spinner.is_finished(),
            "Should be finished after abandon_with_message()"
        );
        ...
        assert!(
            result.is_err(),
            "abandon_with_message should fail if already finished"
        );
    }
